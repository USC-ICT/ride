...
This is the Core UI package for RIDE development. It contains the main user interface elements used by RIDE applications. 

## Overview

RIDE Cognition contains:
* Runtime code: code used by RIDE applications during runtime
