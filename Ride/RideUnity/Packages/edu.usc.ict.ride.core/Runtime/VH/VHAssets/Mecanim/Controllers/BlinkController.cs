...
namespace VHAssets
{
    ...
    public class BlinkController : MonoBehaviour
    {
        ...
        {
            // Mark uninitialized so Blink() and other APIs early-out.
            m_assetInitialized = false;

            // Reset internal blink state machine to a stable "eyes open" state.
            m_state = BlinkState.Idle;
            m_blinkProgress = 0.0f;
            m_nextBlinkTime = 0.0f;

            // Drop references into the (soon-to-be destroyed) loaded art hierarchy.
            m_Animator = null;
