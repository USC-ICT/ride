/*
This is a variant shader on the Unity Standard specular shader. It uses the decal texture slot as a
...
yip@ict.usc.edu
*/
Shader "AG/Brightness/Standard Decal (Specular setup)"
{
	Properties
	{
	...
	CGINCLUDE
        ...
        inline FragmentCommonData_AG SpecularSetup_AGDecal (float4 i_tex)
        {
            ...
            albedo = lerp (albedo, detailAlbedo.rgb, detailAlbedo.a) * _Color.rgb + _Brightness;
		...
		//#define UNITY_SETUP_BRDF_INPUT SpecularSetup_AGDecal
	ENDCG
