...
namespace NonverbalBehaviorGenerator.Legacy
{
    ...
    internal sealed class NVBGSaliencyMap
    {
        ...
        //public static int m_idleGazePeriod = 10;//refactored
        ...
        {
            m_callback?.Invoke(_salMap, _randRange, _keywordRange);
        }

        // update story point GUI
        public static void StoryPointView(string _storyPoint)
        {
            m_storyPointCallBack?.Invoke(_storyPoint);
        }

        // update emotion GUI
        public static void EmotionView(string _emotion)
        {
            m_emotionCallBack?.Invoke(_emotion);
        }
    }
}
